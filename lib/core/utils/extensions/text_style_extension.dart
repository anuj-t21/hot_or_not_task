...
extension TextStyleExtension on TextStyle {
  ...
  // TextStyle get o0 => copyWith(color: 0.0);
  // TextStyle get o1 => copyWith(color: 0.1);
  // TextStyle get o2 => copyWith(color: 0.2);
  // TextStyle get o3 => copyWith(color: 0.3);
  // TextStyle get o4 => copyWith(color: 0.4);
  // TextStyle get o5 => copyWith(color: 0.5);
  // TextStyle get o6 => copyWith(color: 0.6);
  // TextStyle get o7 => copyWith(color: 0.7);
  // TextStyle get o8 => copyWith(color: 0.8);
  // TextStyle get o9 => copyWith(color: 0.9);
  // TextStyle get o10 => copyWith(color: 01.0);
}
